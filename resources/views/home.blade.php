        ...
        <header class="grid h-screen place-items-center justify-items-start bg-cover bg-center" style="background-image: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.3), rgba(23, 23, 23, 0.6), rgba(23, 23, 23, 1)), var(--nb-heroimage);">
            <div class="w-full px-4 mx-auto max-w-7xl sm:px-5 md:px-6 lg:px-8 drop-shadow-lg">
                ...
                <div class="flex flex-row">
                    ...
                    <a class="relative block p-2 tooltip" href="https://discord.com/users/543059753669230623" target="_blank" data-popup="nbert#2620">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="h-5 w-5" viewBox="0 0 16 16">
    ...
    <section>
        ...
        <div class="flex flex-row gap-4 overflow-x-scroll max-w-full no-scrollbar">
            <div class="p-4 rounded-md flex flex-row gap-4 min-w-[30rem] w-fit max-w-[60ch] bg-black">
                <img loading="lazy" src="{{ asset('assets/webgbx.svg') }}" class="aspect-square h-full max-h-[10rem] border border-zinc-500 rounded-full">
